...
$gender_stmt = $pdo->query("
    ...
    GROUP BY sex
");
$stats['gender_individual'] = array_map(fn($r) => ['sex' => $r['sex'], 'count' => (int)$r['count']], $gender_stmt->fetchAll());
...
$gender_household_stmt = $pdo->query("
    ...
    GROUP BY sex
");
$stats['gender_household'] = array_map(fn($r) => ['sex' => $r['sex'], 'count' => (int)$r['count']], $gender_household_stmt->fetchAll());
...
");
$stats['civil_status'] = array_map(fn($r) => ['civil_status' => $r['civil_status'], 'count' => (int)$r['count']], $civil_stmt->fetchAll());
...
");
$stats['education'] = array_map(fn($r) => ['highest_education' => $r['highest_education'], 'count' => (int)$r['count']], $education_stmt->fetchAll());
...
$age_stmt = $pdo->query("
    ...
    ORDER BY 
        ...
        END
");
$stats['age_distribution'] = array_map(fn($r) => ['age_group' => $r['age_group'], 'count' => (int)$r['count']], $age_stmt->fetchAll());
...
$citizenship_stmt = $pdo->query("
    ...
    LIMIT 10
");
$stats['citizenship'] = array_map(fn($r) => ['citizenship' => $r['citizenship'], 'count' => (int)$r['count']], $citizenship_stmt->fetchAll());
...
$occupation_stmt = $pdo->query("
    ...
    LIMIT 10
");
$stats['occupation'] = array_map(fn($r) => ['occupation' => $r['occupation'], 'count' => (int)$r['count']], $occupation_stmt->fetchAll());
