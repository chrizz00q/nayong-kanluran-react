...
// ============================================
// PERMISSION FUNCTIONS (Dynamic from Database)
// ============================================

/**
 * Check if current user has permission for a module/action
 * Uses database-stored permissions for flexibility
 */
function hasPermission($module, $action = 'view') {
    ...
    try {
        ...
        // If database fails, fall back to static permissions
        return hasPermissionStatic($module, $action);
    }
 ...
 */
function hasPermissionStatic($module, $action = 'view') {
    $user_role = $_SESSION['role'] ?? 'enumerator';
